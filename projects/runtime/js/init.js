var init = function (window) {
    ...
    var background = opspark.makeBackground(app, ground); // called makebacground function and stored the background to the variable background
    view.addChild(background); // adds the background as a child of view so it can be seen on screen.
